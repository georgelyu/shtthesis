...
\shtsetup{
  ...
  keywords = {流体仿真，格子玻尔兹曼方法，流固耦合，碰撞模型，边界处理，GPU优化，并行计算},
  keywords* = {Fluid Simulation，Lattice Boltzmann Method，Fluid-Solid Coupling, Collision Model, Boundary treament, GPU Optimization, Parallel Computing},
  author = {吕超阳},
  author* = {Lyu~Chaoyang},
...
\input{contents/c4_auto_boundary}
\input{contents/c5_caa}
\input{contents/c6_results}
\input{contents/c7_conclusion}
